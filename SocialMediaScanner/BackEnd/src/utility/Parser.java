...
//			+ File.separator + "resources" + File.separator;
	 ...
	 */
//	public static final String GRABBER_PATH = Paths.get(".").toAbsolutePath() + 
//			File.separator + "src" + File.separator + "grabber" + File.separator;
	public static final String GRABBER_PATH = Paths.get("").toAbsolutePath() + 
			File.separator + "src" + File.separator + "grabber" + File.separator;
	...
	public static class APIParser {
		...
		private static void initializeSources() throws InstantiationException,
			...
			File api_folder = new File(SOURCE_PATH);
		...
		public static void initAPI(String APIName) throws IOException {
			...
			String config_file = SOURCE_PATH + ("API" + APIName + ".txt");
	...
	public static List<String> getServiceInitConfig() {
		String serviceConfigPath = SOURCE_PATH + File.separator + "ServiceInit.conf";
